...
class ImageSequenceWidget(QtWidgets.QToolButton):
    ...
    def __init__(self, parentWidget, item=None, groupWidget=None, *args):
        QtWidgets.QToolButton.__init__(self, parentWidget, *args)

        self._videoWidget = None
        if item and hasattr(item, "needMovie") and item.needMovie():
            self._videoWidget = studiolibrary.widgets.VideoThumbnailWidget(parent=self, groupWidget=groupWidget)
    ...
    def hasFrames(self):
        ...
        :rtype: bool
        """
        return bool(self.firstFrame()) or self.isVideoPlaying()
    ...
    def firstFrame(self):
        ...
        if self.isVideoPlaying():
            return self._videoWidget.firstFrame()
    ...
    def dirname(self):
        ...
        """
        if self.isVideoPlaying():
            return self._videoWidget.dirname()
    ...
    def resizeEvent(self, event):
        ...
        if self._videoWidget:
           self._videoWidget.setSize(event.size().width(), event.size().height())
    ...
    def setPath(self, path):
        ...
        if self._videoWidget:
            self._videoWidget.setPath(path)
        self.updateIcon()
    ...
    def setDirname(self, dirname):
        ...
        if self._videoWidget:
            self._videoWidget.setPath(dirname)
        self.updateIcon()
    ...
    def isVideoPlaying(self):
        return self._videoWidget and self._videoWidget.isPlaying()
    ...
    def mouseDoubleClickEvent(self, event):
        if self.isVideoPlaying():
            self._videoWidget.openVideoFile()
    ...
    def currentFilename(self):
        ...
        """
        if self.isVideoPlaying():
            return self._videoWidget.currentFilename()
