...
class SidebarWidget(QtWidgets.QWidget):
    ...
    def __init__(self, name="Folders", *args, **kwargs):
        super(SidebarWidget, self).__init__(*args, **kwargs)

        self._dataset = None
        self._lineEdit = None
        self._titleButton = None
        ...
        self._titleWidget = self.createTitleWidget(name)
    ...
    def updateTitle(self, name):
        if self._titleButton:
            self._titleButton.setText(name)

    def createTitleWidget(self, name):
        """
    ...
    def createSettingsMenu(self, menu):
        ...
        :rtype: QMenu
        """
        action = SeparatorAction("Filters", menu)
