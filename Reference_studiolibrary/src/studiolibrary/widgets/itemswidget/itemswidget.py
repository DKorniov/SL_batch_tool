...
class ItemsWidget(QtWidgets.QWidget):
    ...
    def __init__(self, *args):
        ...
        self.itemMovedTree = self.treeWidget().itemMoved
        self.itemDroppedTree = self.treeWidget().itemDropped
    ...
    def labelDisplayOption(self):
        ...
        """
        if self.isIconView():
            return self._labelDisplayOption if self._labelDisplayOption else self.LABEL_DISPLAY_OPTION
