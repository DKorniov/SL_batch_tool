...
def doResetEnableDontShowCheckBox(title):
...
class MessageBox(QtWidgets.QDialog):
    ...
    def input(
        ...
        if not dontShowAgain or not enableDontShowCheckBox:
            ...
            settings.set(key,
                {
                    "clickedButton": int(clickedButton),
                    "dontShowAgain":  bool(dialog.isDontShowCheckboxChecked()),
                }
            )

            return dialog.inputText(), clickedButton
        return inputText, clickedButton

    @staticmethod
    def resetEnableDontShowCheckBox(title):
        doResetEnableDontShowCheckBox(title)
