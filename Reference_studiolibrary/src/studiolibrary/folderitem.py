...
class FolderItem(studiolibrary.LibraryItem):
    ...
    def setIconColor(self, color):
        ...
        paths = self.libraryWindow().selectedFolderPaths()
        for path in paths:
            item = self.libraryWindow().library().itemFromPath(path)
            item.updateMetadata({"color": color})
