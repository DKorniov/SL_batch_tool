...
class SetsItem(baseitem.BaseItem):
    ...
    NAME = "Selection Set"
    EXTENSION = ".set"
    ICON_PATH = os.path.join(os.path.dirname(__file__), "icons", "selectionSet-icon.svg")
    ICON_MENU_PATH = os.path.join(os.path.dirname(__file__), "icons", "selectionSet.png")
