...
class AnimItem(baseitem.BaseItem):
    ...
    NAME = "Animation"
    EXTENSION = ".anim"
    ICON_PATH = os.path.join(os.path.dirname(__file__), "icons", "movie-image-icon.svg")
    ICON_VIDEO_PATH = os.path.join(os.path.dirname(__file__), "icons", "movie-video-icon.svg")
    TRANSFER_CLASS = mutils.Animation

    CM_ICON_PATH = os.path.join(os.path.dirname(__file__), "icons", "animation-menu-icon.svg")
    CM_AA_ICON_PATH = os.path.join(os.path.dirname(__file__), "icons", "animation-AA-icon.svg")
    CM_SL_ICON_PATH = os.path.join(os.path.dirname(__file__), "icons", "animation-library-icon.svg")
    CM_CLIP_ICON_PATH = os.path.join(os.path.dirname(__file__), "icons", "animation-clips-icon.svg")

    def needMovie(self):
        return True
    
    def getIconPath(self):
        if VideoThumbnailWidget.isVideoThumbnail(self.imageSequencePath()):
            return self.ICON_VIDEO_PATH
    ...
    def loadSchema(self):
        ...
        value = "{0} - {1} ({2})".format(startFrame, endFrame, endFrame-startFrame+1)
        ...
        schema.extend([
            ...
            },
            {
                ...
                "type": "enum",
                "default": "replace all",
                "items": ["delete all keys", "replace", "replace all", "insert", "merge"],
                "persistent": True,
            },
            {
                "name": "Help Image",
    ...
    def load(self, **kwargs):
        ...
        anim.load(
            ...
            timeRange=kwargs.get("setTimeRange"),
            useAnimAssist=kwargs.get("useAnimAssist"),
            applyIndex=kwargs.get("apply_index"),
            startFrameForce=kwargs.get("start_frame_force"),
        )
